...
namespace Comercial {
    ...
    public class RptConNF : ReportClass {
    ...
    public class CachedRptConNF : Component, ICachedReport {
        
        public CachedRptConNF() {
        }
